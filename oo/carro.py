...
"""
Você deve criar uma classe carro que vai possuir dois atributos compostos por outrass duas classes:
...
3)Método frear que deverá decrementar a velocidade em duas unnidades.
